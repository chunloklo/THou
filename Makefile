...
OFILES = main.o player.o toncFont.o dma.o img_sprite.o graphics.o display.o sprite.o enemy.o collision.o images.o posprintf.o
# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = color.h input.h player.h img_sprite.h num.h graphics.o display.h sprite.h enemy.h collision.h images.h posprintf.h
